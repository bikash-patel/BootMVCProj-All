...
public class EmployeeController {
	...
	@PostMapping("/search")
	public String searchWithDynamicSearch(Map<String,Object> map,@ModelAttribute("emp") Employee employee) 
	{
		List<Employee> list=service.searchEmployeeWithDynamicSearch(employee);
		map.put("employee",list);
		return "report";
	}
	
	@GetMapping("/report")
	public String reportPage(Map<String,Object> map,@ModelAttribute("emp") Employee employee) 
	{
